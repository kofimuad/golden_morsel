...
# ============================================
# Golden Morsel - File Structure Builder
# Run this INSIDE your golden-morsel folder:
#   cd golden-morsel
#   bash ../scaffold_structure.sh
# ============================================

echo ""
echo "📁 Building Golden Morsel file structure..."
echo ""
...
# ── context / hooks / services / utils / router ─
mkdir -p src/context
mkdir -p src/hooks
...
# ── Write placeholder for all remaining empty files
write_placeholder() {
  local file=$1
  local name
...
export default function ${name}() {
  return (
    <div className="p-4 text-gray-400 text-sm font-sans">
      {/* TODO: ${name} */}
    </div>
  )
}
...
echo ""
echo "✅ All done! Your Golden Morsel frontend is ready."
echo ""
echo "Run:  npm run dev"
echo ""
echo "📂 Drop logo/pattern assets into:"
